    ...
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-center">
          ...
          <Button onClick={() => router.push("/dashboard/admin/weekly-reports/students")}>
            Quay lại
          </Button>
        </div>
      </div>
    ...
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-4 mt-2 text-sm text-gray-500 flex-wrap">
            ...
            {studentInfo.lecturer_name && (
              <>
                <span>•</span>
                <span className="flex items-center gap-1">
                  <UserCheck className="w-4 h-4" />
                  GV: {studentInfo.lecturer_name}
                </span>
              </>
            )}
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Admin có thể xem và đánh giá báo cáo thay giảng viên
          </CardDescription>
        </CardHeader>
        <CardContent>
                    ...
                    <div className="flex-1">
                      ...
                      {report.lecturer_feedback && (
                        <div className="mt-3 p-3 bg-purple-50 border border-purple-200 rounded">
                          <p className="text-xs font-medium text-purple-800 mb-1">Nhận xét:</p>

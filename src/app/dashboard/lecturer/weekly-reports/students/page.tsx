...
export default function LecturerStudentsListPage() {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      // Load all students assigned to this lecturer
      const { data: registrations } = await supabase
        .from("student_registrations")
        .select(`
          id,
    ...
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Báo cáo tuần - Sinh viên</h1>
            <p className="text-gray-500 mt-1">Danh sách sinh viên và tiến độ nộp báo cáo</p>
          </div>
        </div>
        {/* Period Selector */}
        {periods.length > 0 && (
      ...
      {isLoading ? (
        ...
        <Card className="border-2 border-yellow-200">
          <CardContent className="p-12 text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Chưa có sinh viên nào</h3>
            <p className="text-gray-600">Bạn chưa được phân công hướng dẫn sinh viên nào trong bất kỳ kỳ thực tập nào.</p>
          </CardContent>
        </Card>
      ) : !selectedPeriodId ? (
            ...
            <CardContent className="p-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-700">Tổng số sinh viên đang hướng dẫn</p>
                </div>
              </div>
            </CardContent>
          </Card>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  <div className="relative">
                    ...
                    <Input
                      placeholder="Tìm kiếm theo tên, email, MSSV, công ty..."
                      value={searchQuery}
                        ...
                        <TableRow key={student.registration_id} className="hover:bg-gray-50">
                          ...
                          <TableCell className="text-right">
                            <Button
                              variant="outline"
                              size="sm"
                              onClick={() => router.push(`/dashboard/lecturer/weekly-reports/${student.registration_id}`)}
                            >
